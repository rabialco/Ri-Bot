...
public class UnregisteredState extends State {
    ...
    public String register(String userId, String displayName){
        ...
        return "Registrasi sukses. Silahkan masukkan command /makeSession untuk membuat permainan baru";
    }

    public String makeSession(String userId){
        return "Anda belum terdaftar pada sistem Ri-Bot. Silahkan masukkan perintah /register untuk mendaftar";
    }
